...
namespace OmnimarkAmazon.Service
{
    ...
    public sealed class Installer : ServiceInstaller
    {
        ...
        public Installer()
        {
            this.Description = "Multithreading Service to Update Data on ASINs for All Categories";
            this.DisplayName = "UK_Project_Itemlookup_Service";
            this.ServiceName = "UK_Project_Itemlookup_Service";
